  <main class="w-full xl:w-292 2xl:w-full">
     <section id="cartpopup"
      ...
      <div class="w-full h-250 bg-[#BEA301] relative flex flex-col items-center justify-center gap-5 xl:rounded-sm 2xl:rounded-sm">
       ...
       <hr class="w-98 border">
        ...
        <button id="order" class="text-3xl text-[#BEA301] font-bold bg-black py-2 px-12 rounded-full cursor-pointer mb-5">Order</button>
    </section>
    ...
    <section class=" hidden xl:flex items-center justify-center  2xl:gap-25 2xl:py-20">
      <div class="flex flex-col gap-10">
        ...
        <p class="text-3xl text-white w-100 xl:text-5xl/15 xl:w-165 2xl:text-6xl 2xl:w-197">Your Guide In Learning The Concepts and How To Play This Game </p>
      </div>
    ...
    <section class="flex flex-col items-center xl:my-10 xl:gap-10">
      ...
      <p class="text-white text-base w-99 xl:text-3xl/10 xl:w-251 2xl:text-4xl/10 2xl:w-300">Eternals Summoners is a strategic, turn-based card game where players summon
    ...
    <section class="flex flex-col items-center xl:items-start xl:ml-20 xl:gap-12 relative 2xl:ml-80">
      ...
      <p class="text-white text-xl w-100 xl:text-3xl xl:w-168 2xl:text-4xl 2xl:w-190">In the age of fading stars, summoners rise to bind celestial forces and
    ...
    <section class="flex flex-col pl-4 xl:ml-20 xl:p-0 xl:mt-45 2xl:ml-80 2xl:mt-115">
      ...
      <div class="flex w-82 h-104 flex-wrap ml-8 xl:ml-100 xl:xl:scale-300 xl:mt-120 xl:mb-120 2xl:scale-190 2xl:flex-nowrap 2xl:m-0 2xl:mt-65 2xl:ml-20 2xl:gap-10">
    ...
    <section class="my-8 ml-4 xl:mt-10 xl:ml-20 xl:relative 2xl:mt-0">
      <h1 class="text-2xl text-[#AB9100] py-5 xl:text-4xl xl:mb-40 2xl:text-5xl 2xl:ml-64 2xl:mb-50">Chapter III: Card Anatomy</h1>
        ...
        <div class=" w-86 h-114 bg-black relative scale-55 2xl:scale-140 xl:scale-100">
          <div class=" border-3 border-[#9B8400] w-79 h-109 flex flex-col items-center pt-2">
            <div class="border-2 border-[#9B8400] w-74 h-69 ">
              ...
              <div class="w-8 h-8 border border-[#9B8400] bg-black relative bottom-68.5 right-0.5 rotate-45 -20">
                <p class="font-[Maname] text-[#A38B00]  text-3xl absolute -top-3 -left-1 right-3 bottom-4 -rotate-45">9
                </p>
              </div>
            </div>
            <div class="flex pt-2 relative">
              <div class="w-2 h-2 border border-[#BEA301] bg-black rotate-45 absolute top-4.5 -left-4 z-40 "></div>
              <div class="w-4 h-4 border-2 border-[#BEA301] bg-black rotate-45 absolute top-3.5 -left-2.5"></div>
              <p class="border border-[#9B8400] border-solid text-[#9B8400] text-sm px-3 py-1 rounded-2xl">Solarius Veyrion</p>
              <div class="w-4 h-4 border-2 border-[#BEA301] bg-black rotate-45 absolute -right-2.5 top-3.5"></div>
              <div class="w-2 h-2 border border-[#BEA301] bg-black rotate-45 absolute top-4.5 -right-4 z-40"></div>
            </div>
            ...
            <DIv class="flex relative">
              ...
              <p class="text-xs text-[#BEA301] pt-5">“<span class="text-white">Beacon of divine wrath</span>”</p>
      ...
      <div class="relative -top-30 left-10 -scale-y-100 xl:absolute xl:top-168 xl:left-50 xl:-scale-y-200 xl:scale-x-200 2xl:top-195 2xl:left-130">
      ...
      <div class="relative -top-29 -left-12 -scale-100 xl:absolute xl:top-168 xl:left-200 xl:-scale-200 2xl:top-198 2xl:left-280">
        <hr class="w-7 border-0.5 border-[#BEA301] border-solid absolute -rotate-129 left-27.5 -top-0.5 ">
        <hr class="w-29 border-0.5 border-[#BEA301] border-solid absolute -top-3">
      </div>
      <div class="relative -top-40 -left-2 -scale-x-100 xl:absolute xl:top-148 xl:left-230  xl:-scale-x-200 xl:scale-y-200 2xl:top-172 2xl:left-330">
        <hr class="w-7 border-0.5 border-[#BEA301] border-solid absolute -rotate-155 left-27.5 -top-0.5 ">
        <hr class="w-29 border-0.5 border-[#BEA301] border-solid absolute -top-2 -left-1">
      </div>
      <div class="relative -top-41 -left-16 -scale-x-100 xl:absolute xl:top-145 xl:left-210  xl:-scale-x-200 xl:scale-y-200 2xl:top-170 2xl:left-290">
      ...
      <div class="relative -top-80 -left-10 -scale-x-100 xl:absolute xl:top-132 xl:left-210  xl:-scale-x-200 xl:scale-y-200 2xl:top-150 2xl:left-300">
        <hr class="w-7 border-0.5 border-[#BEA301] border-solid absolute -rotate-129 left-27.5 -top-0.5 ">
        <hr class="w-39 border-0.5 border-[#BEA301] border-solid absolute -top-3 -left-10">
      </div>
      <div class="relative -top-51 -left-10 -scale-x-100 xl:absolute xl:top-80 xl:left-210  xl:-scale-x-200 xl:scale-y-200 2xl:top-70 2xl:left-300">
      ...
      <div class="relative">
        <p class="text-white absolute -top-98 -left-2 text-sm xl:text-2xl xl:-top-130 xl:left-32 2xl:-top-150 2xl:left-100">Power Points ( x / 10)</p>
        <p class="text-white absolute -top-50 text-sm xl:text-2xl xl:-top-46 xl:left-31 2xl:-top-35 2xl:left-115">Rarity</p>
        <p class="text-white absolute -top-42 -left-2 text-sm xl:text-2xl xl:-top-28 xl:left-29 2xl:-top-18 2xl:left-95">Attack Points</p>
        <p class="text-white absolute -top-25 left-12 text-sm xl:text-2xl xl:top-4 xl:left-53 2xl:top-18 2xl:left-133">Element</p>
        <p class="text-white absolute -top-25 left-65 text-sm xl:text-2xl xl:top-0 xl:left-142 2xl:top-18 2xl:left-222">Short Description</p>
        <p class="text-white absolute -top-42 left-75 text-xs xl:text-2xl xl:-top-30 xl:left-175 2xl:-top-18 2xl:left-280">Deffense Points</p>
        <p class="text-white absolute -top-48 left-75 text-sm xl:text-2xl xl:-top-40 xl:left-175 2xl:-top-28 2xl:left-275">Role</p>
        <p class="text-white absolute -top-61 left-75 text-sm xl:text-2xl xl:-top-55 xl:left-175 2xl:-top-50 2xl:left-280">Card’s Name</p>
        <p class="text-white absolute -top-88 left-75 text-sm xl:text-2xl xl:-top-111 xl:left-175 2xl:-top-135 2xl:left-280">Caractere</p>
      </div>
        ...
        <div>
          <div>
            <div class="flex items-center justify-between border-[#BEA301] border py-2 px-2 bg-black">
              <p class="text-base text-[#BEA301] xl:text-4xl 2xl:text-5xl">Can I summon multiple cards per turn?</p>
              <div><img class="q1 cursor-pointer" src="imgs/down-arraw.png" alt=" down arrow"></div>
            </div>
            <div>
              <p class="a1 text-base text-white border-[#BEA301] border py-2 px-2 bg-[#2D2A1E] hidden xl:text-4xl 2xl:text-5xl">Only one, unless a
                card allows more.</p>
            </div>
          </div>
          <div>
            <div class="flex items-center justify-between border-[#BEA301] border py-2 px-2 bg-black">
              <p class="text-base text-[#BEA301] xl:text-4xl 2xl:text-5xl">Can I attack the same turn I summon?</p>
              <div><img class="q2 cursor-pointer" src="imgs/down-arraw.png" alt=" down arrow"></div>
            </div>
            <div>
              <p class="a2 text-xs text-white border-[#BEA301] border py-2 px-2 bg-[#2D2A1E] hidden xl:text-4xl 2xl:text-4xl">No. Summoning Fatigue
                prevents immediate attacks.</p>
            </div>
          </div>
          <div>
            <div class="flex items-center justify-between border-[#BEA301] border py-2 px-2 bg-black">
              <p class="text-base text-[#BEA301] xl:text-4xl 2xl:text-5xl">What happens if my deck runs out?</p>
              <div><img class="q3 cursor-pointer" src="imgs/down-arraw.png" alt=" down arrow"></div>
            </div>
            <div>
              <p class="a3 text-base text-white border-[#BEA301] border py-2 px-2 bg-[#2D2A1E] hidden xl:text-4xl 2xl:text-5xl">You lose the game
              </p>
            </div>
          </div>
          <div>
            <div class="flex items-center justify-between border-[#BEA301] border py-2 px-2 bg-black">
              <p class="text-xs text-[#BEA301] xl:text-3xl 2xl:text-4xl">Can I include multiple Above the Rank cards?</p>
              <div><img class="q4 cursor-pointer" src="imgs/down-arraw.png" alt=" down arrow"></div>
            </div>
            <div>
              <p class="a4 text-base text-white border-[#BEA301] border py-2 px-2 bg-[#2D2A1E] hidden xl:text-4xl 2xl:text-5xl">No. Only one per
                deck.</p>
            </div>
          </div>
          <div>
         <div class="flex items-center justify-between border-[#BEA301] border py-2 px-2 bg-black">
            ...
            <div>
              <p class="a5 text-xs text-white border-[#BEA301] border py-2 px-2 bg-[#2D2A1E] hidden xl:text-4xl 2xl:text-4xl">Yes. Elemental
