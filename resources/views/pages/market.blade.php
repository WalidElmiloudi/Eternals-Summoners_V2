...
@section('content')
    <main class="xl:w-292 2xl:w-full w-full">
        ...
        <section class="flex flex-col items-center xl:hidden 2xl:hidden gap-y-5 mt-5">
            ...
            <p class="text-3xl text-white w-100">Add Cards To Your Collection Or Get Rid Of The No More Useful Ones By
                Selling
                Them</p>
        ...
        <section class="flex flex-col items-center">
            <div class="flex justify-between xl:justify-around py-5 gap-2.5 2xl:gap-18 xl:gap-12">
                <p class="filter-btn text-[#8800FF] text-[10px] xl:text-2xl cursor-pointer" data-rarity="Above The Rank">
                    Above
                    The Rank</p>
                <p class="filter-btn text-[#FF0000] text-xs xl:text-2xl cursor-pointer" data-rarity="Mythical">Mythical</p>
                <p class="filter-btn text-[#BEA301] text-xs xl:text-2xl cursor-pointer" data-rarity="Legendary">Legendary
                </p>
