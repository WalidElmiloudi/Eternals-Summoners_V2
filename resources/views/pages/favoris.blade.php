  <main class="xl:w-292 2xl:w-full w-full mb-18">
    ...
    <section class=" hidden xl:flex flex-col items-center 2xl:flex mb-8 2xl:gap-25 2xl:pt-25">
      <div class="flex items-center justify-center">
        <div class="flex flex-col gap-10">
          ...
          <p class="text-3xl text-white w-100 xl:text-5xl/15 xl:w-160 2xl:text-6xl 2xl:w-197">Every Cards You Add to
    ...
    <section class="flex flex-col items-center">
      <div id="favoritesDisplay"
        class="grid grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 gap-x-4 gap-y-4 justify-items-center 2xl:w-277 "></div>
      ...
      <div class=" gap-x-5 justify-center my-10 2xl:my-20 hidden">
        <div class="w-15 h-15 xl:w-20 xl:h-20 border border-[#BEA301] flex justify-center items-center rounded-full">
